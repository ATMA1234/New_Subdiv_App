...
public class ConstantValues {
    public static final String FILE_TRM_DATABASE = "mydb.db";
    public static final String FILE_TRM_JOURNAL = FILE_TRM_DATABASE+"-journal";
    ...
    public static final int BILLING_TIME_OVER=3;
}
